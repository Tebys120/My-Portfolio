...
const Projects = () => {
    return (
        <div id="projects" className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
            ...
            <p className='text-center py-8'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero dicta soluta, voluptatum incidunt amet id, quidem molestias ipsum nam unde quaerat ipsa eum repudiandae alias adipisci, omnis dolore iste excepturi!</p>
